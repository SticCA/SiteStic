...
<head>
    ...
    <title>Spécialisations - <?php echo strtoupper($site); ?></title>
        ...
        <div class="row">
            <article class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar" id="sidebar-menu">
                    ...
                    <li class="active"><a href="../<?php echo $site; ?>/specialisations"><i class="flaticon-mark1"></i> Spécialisations</a></li>
