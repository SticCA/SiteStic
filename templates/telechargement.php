...
<head>
    ...
    <title>Téléchargement - <?php echo strtoupper($site); ?></title>
            ...
            <div class="container">
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="../<?php echo $site; ?>/cadidater">Candidater</a></li>
        ...
        <div class="row">
            <article class="col-sm-3 col-md-2 sidebar">
                <ul class="nav nav-sidebar" id="sidebar-menu">
                    ...
                    <li class="active"><a href="../<?php echo $site; ?>/telechargement"><i class="flaticon-downloading"></i> Téléchargement</a></li>
                </ul>
